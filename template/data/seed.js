...
Object.keys(connection.collections).forEach(collection => {
  ...
  // //     if (collection === 'auctions') { Attack.collection.drop(); }
  // //     if (collection === 'auctionbids') { Attack.collection.drop(); }
        ...
        [
          {
            ...
            images: [
              "http://imageExamples.com/ScaryFaces1.jpg",
              "http://imageExamples.com/ScaryFaces2.jpg"
            ],
          ...
          {
            title: "Funny oranges",
            artistId: getResourceIdByName(
              artists,
              "name",
              "Johnny Sven Haraldsson"
            ),
            date: new Date(), // TODO: FIX
            images: [
              "http://imageExamples.com/FunnyOranges1.jpg",
          ...
          },
          {
            ...
            artistId: getResourceIdByName(
              artists,
              "name",
              "Smari Freyr Gudmundsson"
            ),
            date: new Date(), // TODO: FIX
            images: [
              "http://imageExamples.com/FlyingDogsInTheSummerHouse1.jpg"
            ],
          ...
          },
          {
            ...
            artistId: getResourceIdByName(
              artists,
              "name",
              "Carlo Peter Davidsson"
            ),
            date: new Date(), // TODO: FIX
            images: [
              "http://imageExamples.com/GhostCows1.jpg",
              "http://imageExamples.com/GhostCows2.jpg"
            ],
              ...
              err => {
                ...
                Customer.find({}, (err, customers) => {
                  ...
                  Auction.insertMany(
                    [
                      {
                        artId: getResourceIdByName(
                          arts,
                          "title",
                          "Scary faces"
                        ),
                        minimumPrice: 10,
                        endDate: "2019-10-10T14:40:22.813Z",
                        auctionWinner: getResourceIdByName(
                          customers,
                          "username",
                          "PeterM"
                        )
                      },
                      {
                        artId: getResourceIdByName(
                          arts,
                          "title",
                          "Flying dogs in the summer house"
                        ),
                    ...
                    err => {
                      ...
                      Auction.find({}, (err, auctions) => {
                        ...
                        AuctionBid.insertMany(
                          [
                            {
                              auctionId: getResourceIdByName(
                                auctions,
                                "minimumPrice",
                                10
                              ),
                              customerId: getResourceIdByName(
                                customers,
                                "username",
                                "PeterM"
                              ),
